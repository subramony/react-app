/*getInitialState : function(){
  ...
  storeNumberChange : function(value) {
    console.log('You\'ve selected:', value);
      this.setState({ storeValue : value});
  },
  eventTypeChange : function (value) {
    console.log('You\'ve selected:', value);
  ...
  render : function () {
    return (
    <div> 
    <div className={(!this.state.visible ? "in-visible " : "") + "sidebar"}>              
      <form>
        <div className="form-group">
          <label > Country Code </label>
          <Select multi simpleValue  value={this.state.countryValue} placeholder="Select your country(s)" options={this.state.options} onChange={this.countryCodeChange} className=""/>
        </div>
        <div className="form-group">
          <label > Store Number </label>
          <Select multi simpleValue  value={this.state.storeValue} placeholder="Select your Store Number(s)" options={this.state.stores} onChange={this.storeNumberChange} className=""/>
        </div>
          <div className="form-group">
          <label > Event Type </label>
          <Select multi simpleValue  value={this.state.eventValue} placeholder="Select your Event Type(s)" options={this.state.events} onChange={this.eventTypeChange} className=""/>
        </div>
       </form>
    </div>               
       <div className="content">
        <button className="btn glyphicon glyphicon-plus" onClick={this.showOrHide}>
        </button>       
       </div> 
       <div className={(!this.state.visible ? "in-visible " : "") + "sidebar-right"}>         
          <Graph/>            
       </div> 
     </div>
    );
